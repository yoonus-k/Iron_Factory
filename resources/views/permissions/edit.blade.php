...
<div class="container-fluid" dir="rtl">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">{{ __('permissions.edit_permission') }}: {{ $permission->permission_name }}</h2>
    ...
    <div class="alert alert-warning">
        ...
        {{ __('permissions.system_permission_warning') }}
    </div>
    @endif
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">{{ __('permissions.permission_code') }}</label>
                        <input type="text" class="form-control" value="{{ $permission->permission_code }}" disabled>
                        <small class="form-text text-muted">{{ __('permissions.code_cannot_be_edited') }}</small>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="is_active">{{ __('permissions.is_active') }}</label>
                        </div>
                    </div>
                </div>
            </div>
