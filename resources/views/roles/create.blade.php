                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="display_name" type="text" name="display_name" class="form-input @error('display_name') is-invalid @enderror" value="{{ old('display_name') }}" required>
                        </div>
                        @error('display_name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="name" type="text" name="name" class="form-input @error('name') is-invalid @enderror" value="{{ old('name') }}">
                        </div>
                        @error('name')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="level" type="number" name="level" class="form-input @error('level') is-invalid @enderror" min="0" max="100" value="{{ old('level', 50) }}" required>
                        </div>
                        @error('level')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="input-wrapper">
                            ...
                            <textarea id="description" name="description" rows="3" class="form-input @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
