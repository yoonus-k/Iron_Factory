    ...
    <div class="um-header-section">
        <div class="header-content">
            <h1 class="um-page-title">
                ...
                {{ __('roles.edit_role') }}: {{ $role->role_name }}
            </h1>
            <p class="header-subtitle">{{ __('roles.edit_role_subtitle') }}</p>
        </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">{{ __('roles.update_role_data') }}</p>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select id="is_active" name="is_active" class="form-input @error('is_active') is-invalid @enderror">
                                <option value="1" {{ old('is_active', $role->is_active) ? 'selected' : '' }}>{{ __('roles.yes') }}</option>
                                <option value="0" {{ !old('is_active', $role->is_active) ? 'selected' : '' }}>{{ __('roles.no') }}</option>
                            </select>
                        </div>
                        @error('is_active')
                            <span class="error-message">{{ $message }}</span>
