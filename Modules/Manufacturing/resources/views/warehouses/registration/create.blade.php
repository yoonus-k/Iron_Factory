                    ...
                    <div class="col">
                        ...
                        <div style="background: white; padding: 12px; border-radius: 4px; border-left: 3px solid #f39c12; margin-bottom: 12px;">
                            <small style="display: grid; gap: 6px;">
                                <span><strong>📊 الوزن:</strong> {{ number_format($previousLog->weight_recorded ?? 0, 2) }} كيلو</span>
                                <span><strong>📍 الموقع:</strong> {{ $previousLog->location ?? 'غير محدد' }}</span>
                                <span><strong>🏷️ النوع:</strong> {{ $previousLog->materialType->type_name ?? 'غير محدد' }}</span>
                                <span><strong>👤 المسجل:</strong> {{ $previousLog->registeredBy->name ?? 'مستخدم محذوف' }}</span>
                                <span><strong>⏰ التاريخ:</strong> {{ $previousLog->registered_at?->format('d/m/Y H:i') ?? 'N/A' }}</span>
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info mb-3" style="display: flex; gap: 10px; align-items: flex-start;">
                            ...
                            <div>
                                <strong>💡 نصيحة:</strong> تأكد من قراءة الوزن من الميزان مباشرة والمطابقة مع الفحص الفيزيائي للبضاعة
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label"><strong>الوزن الفعلي من الميزان (كيلو) <span class="text-danger">*</span></strong></label>
                            <div class="input-group">
                                <input type="number"
                                       name="actual_weight"
                                       class="form-control @error('actual_weight') is-invalid @enderror"
                                       placeholder="مثال: 1000.50"
                                       step="0.01"
                                       min="0.01"
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label"><strong>الوحدة <span class="text-danger">*</span></strong></label>
            ...
            <div class="card-body">
                <div class="form-check mb-4">
                    ...
                    <label class="form-check-label" for="confirmCheck">
                        <strong>✓ أؤكد أن جميع البيانات صحيحة وقد تم التحقق منها بدقة من الميزان والفحص الفيزيائي</strong>
                    </label>
                </div>
