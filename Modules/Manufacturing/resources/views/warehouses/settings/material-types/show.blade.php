        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="actions-grid">
                    ...
                    <form method="POST" action="{{ route('manufacturing.warehouse-settings.material-types.toggle-status', $materialType->id) }}" style="flex: 1;">
                        @csrf
                        @method('PUT')
                        <button type="submit" class="action-btn" style="width: 100%; background-color: {{ $materialType->is_active ? '#e74c3c' : '#27ae60' }};">
                            <div class="action-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <polyline points="12 6 12 12 16 14"></polyline>
                            ...
                            <div class="action-text">
                                <h5>{{ $materialType->is_active ? 'تعطيل النوع' : 'تفعيل النوع' }}</h5>
                                <p>{{ $materialType->is_active ? 'تعطيل هذا النوع' : 'تفعيل هذا النوع' }}</p>
                            </div>
                        </button>
                    </form>
