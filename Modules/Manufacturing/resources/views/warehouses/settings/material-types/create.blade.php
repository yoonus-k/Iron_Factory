...
@section('content')
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form method="POST" action="{{ route('manufacturing.warehouse-settings.material-types.store') }}" id="materialTypeForm">
            @csrf
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">أدخل وصف النوع وشروط التخزين</p>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    Swal.fire({
                        title: 'تأكيد الحفظ',
                        text: 'هل أنت متأكد من حفظ بيانات نوع المادة؟',
                        icon: 'question',
