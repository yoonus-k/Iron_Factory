                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="shift_code" id="shift_code"
                                    class="form-input"
                                    value="SHIFT-2025-004" placeholder="أدخل رقم الوردية" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select name="supervisor_id" id="supervisor_id"
                                    ...
                                    <option value="1" selected>أحمد محمد</option>
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="input-wrapper">
                                ...
                                <textarea name="notes" id="notes" rows="4"
                                    class="form-input" placeholder="أدخل ملاحظات للوردية"></textarea>
                            </div>
                        </div>
                ...
                <div class="form-section">
                    <div class="section-header">
                        ...
                        <div>
                            ...
                            <p class="section-subtitle">حدد العمال الذين سيشاركون في هذه الوردية</p>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <div class="workers-selection">
                                ...
                                <div class="worker-item">
                                    <input type="checkbox" id="worker_4" name="workers[]" value="4">
                                    <label for="worker_4">خالد أحمد - عامل تقطيع</label>
                                </div>
                                <div class="worker-item">
                                    <input type="checkbox" id="worker_5" name="workers[]" value="5" checked>
