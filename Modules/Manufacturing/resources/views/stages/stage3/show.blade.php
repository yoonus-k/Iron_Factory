                ...
                <div class="header-left">
                    ...
                    <div class="header-info">
                        ...
                        <div class="badges">
                            ...
                            <span class="badge active">جاهز</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid">
            <div class="card">
                <div class="card-header">
                    ...
                    <h3 class="card-title">معلومات الكويل</h3>
                </div>
                <div class="card-body">
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">بولي إيثيلين</div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">15 كيلوغرام</div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">20 كيلوغرام</div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><strong class="text-success">250 كجم</strong></div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><span class="badge badge-warning">3.5%</span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            <span class="status active">جاهز</span>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="info-item">
                        <div class="info-value">الكويل جاهز للمرحلة التالية.</div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="schedule-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">2025-01-15 15:30 - انتقل للمرحلة الرابعة</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="actions-grid">
                    <a href="{{ route('manufacturing.stage2.index') }}" class="action-btn activate" style="background: linear-gradient(135deg, #9E9E9E, #757575);">
                        ...
                        <div class="action-text">
                            <h4>⬅️ عودة للمرحلة 2</h4>
                            <p>العودة لقائمة المعالجات</p>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('manufacturing.stage3.edit', $stage3->id ?? 1) }}" class="action-btn activate">
                        ...
                        <div class="action-text">
                            <h4>تعديل الكويل</h4>
                            <p>تعديل تفاصيل الكويل</p>
                        </div>
                    </a>

                    <a href="{{ route('manufacturing.stage4.create') }}" class="action-btn activate" style="background: linear-gradient(135deg, #4CAF50, #45a049);">
                        <div class="action-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="action-text">
                            <h4>➡️ انتقل للمرحلة 4</h4>
                            <p>نقل الكويل للتعبئة والتغليف</p>
                        </div>
                    </a>
                    ...
                    <button type="button" class="action-btn delete">
                        ...
                        <div class="action-text">
                            <h4>حذف الكويل</h4>
                            <p>حذف نهائي للكويل من النظام</p>
                        </div>
                    </button>
                </div>
            </div>
        ...
        <div class="card" style="margin-top: 20px; background: linear-gradient(135deg, #e8f5e9, #f1f8e9); border-left: 5px solid #4CAF50;">
            ...
            <div class="card-body">
                <div style="display: flex; align-items: center; justify-content: space-between; gap: 20px;">
                    <div>
                        <h4 style="margin: 0 0 5px 0; color: #2e7d32;">المرحلة الرابعة: التعبئة والتغليف</h4>
                        <p style="margin: 0; color: #558b2f; font-size: 14px;">اضغط الزر أدناه لنقل هذا الكويل إلى مرحلة التعبئة والتغليف</p>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    e.preventDefault();
                    if (confirm('⚠️ هل أنت متأكد من حذف هذا الكويل؟\n\nهذا الإجراء لا يمكن التراجع عنه!')) {
