...
@section('title', 'تعديل بيانات الاستاند')
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">قم بتحديث البيانات الأساسية للاستاند</p>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="barcode" id="barcode" class="form-input" value="ST1-001-2025" placeholder="الباركود" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select name="material_id" id="material_id" class="form-input" required>
                                ...
                                <option value="1" selected>مادة خام رقم 1 - حديد مسلح</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="stand_number" id="stand_number" class="form-input" value="ST-001" placeholder="رقم الاستاند" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" name="wire_size" id="wire_size" class="form-input" value="2.5" placeholder="حجم السلك" step="0.1" min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" name="weight" id="weight" class="form-input" value="250" placeholder="الوزن" step="0.01" min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" name="waste_percentage" id="waste_percentage" class="form-input" value="5.2" placeholder="نسبة الهدر" step="0.01" min="0" max="100">
                        </div>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="input-wrapper">
                            ...
                            <textarea name="notes" id="notes" rows="4" class="form-input" placeholder="أدخل ملاحظات للاستاند">تم التقسيم بنجاح. الاستاند جاهز للمرحلة التالية.</textarea>
                        </div>
                    </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">قم بتحديث المعلومات الإضافية للاستاند</p>
                    </div>
                </div>
