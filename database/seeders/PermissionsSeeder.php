...
class PermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            // Shifts & Workers Core Permissions
            ['name' => 'SHIFT_WORKERS_READ', 'display_name' => 'عرض الورديات والعمال', 'display_name_en' => 'View Shifts & Workers', 'group_name' => 'الورديات والعمال', 'group_name_en' => 'Shifts & Workers', 'description' => 'عرض قائمة الورديات والعمال', 'description_en' => 'View Shifts & Workers List'],
            ['name' => 'SHIFT_WORKERS_VIEW', 'display_name' => 'عرض تفاصيل الوردية', 'display_name_en' => 'View Shift Details', 'group_name' => 'الورديات والعمال', 'group_name_en' => 'Shifts & Workers', 'description' => 'عرض تفاصيل الوردية والعمال', 'description_en' => 'View Shift Details'],
            ['name' => 'SHIFT_WORKERS_UPDATE', 'display_name' => 'تعديل الوردية والعمال', 'display_name_en' => 'Edit Shifts & Workers', 'group_name' => 'الورديات والعمال', 'group_name_en' => 'Shifts & Workers', 'description' => 'تعديل بيانات الوردية والعمال', 'description_en' => 'Edit Shifts & Workers Data'],
            ...
            ['name' => 'SHIFTS_UPDATE', 'display_name' => 'تعديل الوردية', 'display_name_en' => 'Edit Shift', 'group_name' => 'الورديات والعمال', 'group_name_en' => 'Shifts & Workers', 'description' => 'تعديل وتفعيل وإكمال وتعليق واستئناف الورديات', 'description_en' => 'Edit and manage shift status'],
            ...
            // ============================================
            // تتبع العمال - Worker Tracking
            // ============================================
            ['name' => 'MENU_WORKER_TRACKING', 'display_name' => 'تتبع العمال', 'display_name_en' => 'Worker Tracking', 'group_name' => 'تتبع العمال', 'group_name_en' => 'Worker Tracking', 'description' => 'إظهار قائمة تتبع العمال', 'description_en' => 'Show Worker Tracking Menu'],
            ['name' => 'WORKER_TRACKING_DASHBOARD', 'display_name' => 'لوحة تحكم تتبع العمال', 'display_name_en' => 'Worker Tracking Dashboard', 'group_name' => 'تتبع العمال', 'group_name_en' => 'Worker Tracking', 'description' => 'الوصول لصفحة تتبع العمال', 'description_en' => 'Access Worker Tracking Dashboard'],
            ['name' => 'WORKER_TRACKING_VIEW_HISTORY', 'display_name' => 'عرض سجل المراحل', 'display_name_en' => 'View Stage History', 'group_name' => 'تتبع العمال', 'group_name_en' => 'Worker Tracking', 'description' => 'عرض سجل مراحل العامل', 'description_en' => 'View Worker Stage History'],
            ['name' => 'WORKER_TRACKING_EXPORT', 'display_name' => 'تصدير بيانات التتبع', 'display_name_en' => 'Export Tracking Data', 'group_name' => 'تتبع العمال', 'group_name_en' => 'Worker Tracking', 'description' => 'تصدير بيانات تتبع العمال', 'description_en' => 'Export Worker Tracking Data'],
