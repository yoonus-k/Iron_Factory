...
class SystemSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                'setting_key' => 'production_waste_percentage',
                'setting_value' => '3',
                'setting_value_en' => '3',
                'setting_type' => 'number',
                'category' => 'waste_limits',
                'description' => 'نسبة الهدر المسموح بها في جميع مراحل الإنتاج (%) - عند تجاوزها يتم إيقاف المرحلة تلقائياً وإرسال تنبيه',
                'description_en' => 'Allowed waste percentage in all production stages (%) - triggers automatic stage suspension and alert',
                'is_public' => false,
            ],
            [
